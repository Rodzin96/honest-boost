...
function renderAppGrid(category, query) {
  ...
  grid.innerHTML = items.map(app => {
    ...
    return `
    <div class="app-card">
      <div class="app-card-header"><div class="app-card-icon${app.art ? ' has-art' : ''}">${app.art ? `<img src="https://cdn.simpleicons.org/${app.art}/E8ECF4" alt="" width="26" height="26" loading="eager" draggable="false">` : ''}<span>${app.icon}</span></div>${statusTag}</div>
  ...
  // Ícones: esconde o fallback de texto quando a imagem carrega de verdade
  // (listeners via JS — handlers inline são bloqueados pelo CSP).
  grid.querySelectorAll('.app-card-icon.has-art').forEach(box => {
    const img = box.querySelector('img'), label = box.querySelector('span');
    if (!img || !label) return;
    const hideLabel = () => { label.style.display = 'none'; };
    if (img.complete && img.naturalWidth > 0) hideLabel();
    else {
      img.addEventListener('load', hideLabel, { once: true });
...
const GAME_PROFILES = [
  ...
  { match: ['tekken', 'street fighter', 'mortal kombat', 'dragon ball', 'guilty gear', 'king of fighters'], name: 'Perfil Luta', desc: '60 FPS cravados', ids: SET_BASE },
  { match: ['stalker', 'metro ', 'atomic heart'], name: 'Perfil Zona', desc: 'Sobreviva à Zona', ids: SET_FPS },
  { match: ['hades', 'hollow knight', 'celeste', 'dead cells', 'ori ', 'cuphead', 'vampire survivors', 'balatro', 'slay the spire', 'tunic', 'stray', 'dave the diver', 'outer wilds'], name: 'Perfil Indie', desc: 'Precisão total, PC leve', ids: SET_LIGHT },
  { match: ['portal', 'half-life', 'it takes two', 'a way out'], name: 'Perfil Aventura', desc: 'História sem engasgos', ids: SET_BASE },
  { match: ['flight simulator', 'msfs', 'elite dangerous', 'no man'], name: 'Perfil Simulador', desc: 'Simulação pesada afinada', ids: SET_FPS },
...
const GAME_CATALOG = [
  ...
  ['Team Fortress 2', 'Perfil TF2'], ['Rocket League', 'Perfil Futebol'],
  ...
  ['Sleeping Dogs', 'Perfil Mundo Aberto'], ['Bully', 'Perfil Mundo Aberto'],
  ['Max Payne 3', 'Perfil Mundo Aberto'], ['L.A. Noire', 'Perfil Mundo Aberto'],
  ['Cyberpunk 2077', 'Perfil Cyberpunk'], ['Elden Ring', 'Perfil Soulslike'],
  ['Dark Souls III', 'Perfil Soulslike'], ['Sekiro', 'Perfil Soulslike'],
  ['Lies of P', 'Perfil Soulslike'], ['Armored Core VI', 'Perfil Soulslike'],
  ["Baldur's Gate 3", 'Perfil RPG Tático'], ['Yakuza 0', 'Perfil RPG Tático'],
  ['Persona 5 Royal', 'Perfil RPG Tático'], ['Minecraft', 'Perfil Minecraft'],
  ['Roblox', 'Perfil Roblox'], ['EA FC', 'Perfil Futebol'],
  ['eFootball', 'Perfil Futebol'], ['Dota 2', 'Perfil MOBA'],
  ['Diablo IV', 'Perfil ARPG'], ['Path of Exile', 'Perfil ARPG'],
  ['Last Epoch', 'Perfil ARPG'], ['Grim Dawn', 'Perfil ARPG'],
  ['World of Warcraft', 'Perfil MMO'], ['Guild Wars 2', 'Perfil MMO'],
  ['Black Desert', 'Perfil MMO'], ['Lost Ark', 'Perfil MMO'],
  ['New World', 'Perfil MMO'], ['Throne and Liberty', 'Perfil MMO'],
  ['Elder Scrolls Online', 'Perfil MMO'],
  ['Palworld', 'Perfil Co-op'], ['Helldivers 2', 'Perfil Co-op'],
  ['Lethal Company', 'Perfil Co-op'], ['Phasmophobia', 'Perfil Co-op'],
  ['Left 4 Dead 2', 'Perfil Co-op'], ['Content Warning', 'Perfil Co-op'],
  ['Core Keeper', 'Perfil Co-op'], ['V Rising', 'Perfil Co-op'],
  ['Once Human', 'Perfil Co-op'], ['Terraria', 'Perfil Co-op'],
  ['Hunt: Showdown', 'Perfil Co-op'], ['Dead by Daylight', 'Perfil Co-op'],
  ['Back 4 Blood', 'Perfil Co-op'], ['Vermintide 2', 'Perfil Co-op'],
  ['Darktide', 'Perfil Co-op'], ['Deep Rock Galactic', 'Perfil Co-op'],
  ['Payday 2', 'Perfil Co-op'], ['Payday 3', 'Perfil Co-op'],
  ['Borderlands 3', 'Perfil Co-op'], ['Tiny Tina', 'Perfil Co-op'],
  ['Remnant 2', 'Perfil Co-op'], ['It Takes Two', 'Perfil Co-op'],
  ['A Way Out', 'Perfil Co-op'], ['Portal 2', 'Perfil Co-op'],
  ['Far Cry 6', 'Perfil Ubisoft'],
  ['Outlast', 'Perfil Terror'], ['Resident Evil 4', 'Perfil Terror'],
  ['Resident Evil 2', 'Perfil Terror'], ['Resident Evil 7', 'Perfil Terror'],
  ['Resident Evil Village', 'Perfil Terror'], ['Dead Space', 'Perfil Terror'],
  ['Silent Hill 2', 'Perfil Terror'], ['Callisto Protocol', 'Perfil Terror'],
  ['SOMA', 'Perfil Terror'], ['Alien: Isolation', 'Perfil Terror'],
  ['Dying Light', 'Perfil Co-op'], ['Dying Light 2', 'Perfil Co-op'],
  ['Dead Island 2', 'Perfil Co-op'], ['State of Decay 2', 'Perfil Co-op'],
  ['7 Days to Die', 'Perfil Co-op'], ['Project Zomboid', 'Perfil Co-op'],
  ['Hogwarts Legacy', 'Perfil Hogwarts'], ['Starfield', 'Perfil Bethesda'],
  ['God of War', 'Perfil Ports Sony'], ['Spider-Man', 'Perfil Ports Sony'],
  ['Horizon Zero Dawn', 'Perfil Ports Sony'], ['The Last of Us Part I', 'Perfil Ports Sony'],
  ['Uncharted', 'Perfil Ports Sony'], ['Ghost of Tsushima', 'Perfil Ports Sony'],
  ['Days Gone', 'Perfil Ports Sony'], ['Ratchet & Clank', 'Perfil Ports Sony'],
  ['Death Stranding', 'Perfil Ports Sony'], ['Returnal', 'Perfil Ports Sony'],
  ['Detroit: Become Human', 'Perfil Ports Sony'],
  ['Forza Horizon 5', 'Perfil Corrida'], ['The Witcher 3', 'Perfil The Witcher'],
  ['Tekken 8', 'Perfil Luta'], ['Street Fighter 6', 'Perfil Luta'],
  ['Mortal Kombat 1', 'Perfil Luta'], ['Dragon Ball: Sparking Zero', 'Perfil Luta'],
  ['Stalker 2', 'Perfil Zona'], ['Metro Exodus', 'Perfil Zona'],
  ['Atomic Heart', 'Perfil Zona'],
  ['Hades', 'Perfil Indie'], ['Hollow Knight', 'Perfil Indie'],
  ['Celeste', 'Perfil Indie'], ['Dead Cells', 'Perfil Indie'],
  ['Ori and the Blind Forest', 'Perfil Indie'], ['Cuphead', 'Perfil Indie'],
  ['Vampire Survivors', 'Perfil Indie'], ['Balatro', 'Perfil Indie'],
  ['Slay the Spire', 'Perfil Indie'], ['Tunic', 'Perfil Indie'],
  ['Stray', 'Perfil Indie'], ['Dave the Diver', 'Perfil Indie'],
  ['Outer Wilds', 'Perfil Indie'],
  ['Half-Life: Alyx', 'Perfil Aventura'],
  ['Microsoft Flight Simulator', 'Perfil Simulador'],
  ['Elite Dangerous', 'Perfil Simulador'], ["No Man's Sky", 'Perfil Simulador'],
  ['Age of Empires II', 'Perfil Estratégia'], ['Age of Empires IV', 'Perfil Estratégia'],
  ['Civilization VI', 'Perfil Estratégia'], ['Civilization VII', 'Perfil Estratégia'],
  ['Total War: Warhammer III', 'Perfil Estratégia'],
  ['Crusader Kings III', 'Perfil Estratégia'], ['Stellaris', 'Perfil Estratégia'],
  ['Northgard', 'Perfil Estratégia'], ['Frostpunk', 'Perfil Estratégia'],
  ['Frostpunk 2', 'Perfil Estratégia'], ['Hearts of Iron IV', 'Perfil Estratégia'],
  ['StarCraft II', 'Perfil Estratégia'],
];
...
// Arte oficial via CDN da Steam (header 460x215). Só IDs verificados —
// na dúvida, sem appid (avatar em gradiente). Fallback automático se offline.
const STEAM_ART = 'https://cdn.cloudflare.steamstatic.com/steam/apps/';
const GAME_ART = {
  'Counter-Strike 2': 730, 'Dota 2': 570, 'PUBG: Battlegrounds': 578080,
  'Apex Legends': 1172470, 'Rust': 252490, 'ARK: Survival': 346110,
  'GTA V': 271590, 'Red Dead Redemption 2': 1174180, 'Cyberpunk 2077': 1091500,
  'Elden Ring': 1245620, "Baldur's Gate 3": 1086940, 'Starfield': 1716740,
  'Warframe': 230410, 'Destiny 2': 1085660, 'Team Fortress 2': 440,
  'Left 4 Dead 2': 550, 'Minecraft': 0, 'Roblox': 0,
  'Terraria': 105600, 'Stardew Valley': 413150, 'Civilization VI': 289070,
  'Civilization VII': 1295660, 'Total War: Warhammer III': 1142710,
  'Crusader Kings III': 1158310, 'Stellaris': 281990, 'Hearts of Iron IV': 394360,
  'Northgard': 466560, 'Age of Empires II': 813780, 'Age of Empires IV': 1466860,
  'Frostpunk': 323190, 'Frostpunk 2': 1601580,
  'Microsoft Flight Simulator': 1250410, 'Elite Dangerous': 359320,
  "No Man's Sky": 275850, 'S.T.A.L.K.E.R. 2': 1643320, 'Metro Exodus': 412020,
  'Atomic Heart': 668490, 'Hades': 1145360, 'Hollow Knight': 367520,
  'Celeste': 504230, 'Dead Cells': 588650, 'Ori and the Blind Forest': 387290,
  'Cuphead': 268910, 'Path of Exile': 238960, 'Last Epoch': 899770,
  'Grim Dawn': 219990, 'Guild Wars 2': 1284210, 'Black Desert': 582660,
  'Lost Ark': 1599340, 'New World': 1062090, 'Throne and Liberty': 2429640,
  'Elder Scrolls Online': 306130, 'Forza Horizon 5': 1551360,
  'Halo Infinite': 1240440, 'Helldivers 2': 553850, 'Lethal Company': 1966720,
  'Phasmophobia': 739630, 'Content Warning': 2881650, 'Palworld': 1623730,
  'Valheim': 892970, 'Core Keeper': 1621690, 'V Rising': 1604030,
  'Once Human': 2139460, 'Overwatch 2': 2357570, 'Rainbow Six Siege': 359550,
  'Rocket League': 252950, 'Fall Guys': 1097150, 'Stumble Guys': 1677740,
  'Marvel Rivals': 2767030, 'The Finals': 2073850, 'Battlefield 2042': 1517290,
  'War Thunder': 236390, 'World of Tanks': 1407200,
  'Call of Duty: Warzone': 1938090, 'Tekken 8': 1778820,
  'Street Fighter 6': 1364780, 'Mortal Kombat 1': 1971870,
  'Dragon Ball: Sparking Zero': 1790600, 'Hogwarts Legacy': 990080,
  'God of War': 1593500, 'Spider-Man': 1817070, 'The Witcher 3': 292030,
  'Outlast': 238320, 'Resident Evil 4': 2050650, 'Resident Evil 2': 883710,
  'Resident Evil 7': 418370, 'Resident Evil Village': 1196590,
  'Dead Space': 1693980, 'Silent Hill 2': 2124490, 'Callisto Protocol': 1544020,
  'Dying Light': 239140, 'Dying Light 2': 534380, 'Dead Island 2': 934700,
  'State of Decay 2': 329430, '7 Days to Die': 251570, 'Project Zomboid': 108600,
  'Hunt: Showdown': 594650, 'Dead by Daylight': 381210, 'Back 4 Blood': 924970,
  'Vermintide 2': 552500, 'Darktide': 1361210, 'Deep Rock Galactic': 548430,
  'Payday 2': 218620, 'Payday 3': 1272080, 'Borderlands 3': 397540,
  'Tiny Tina': 1286680, 'Remnant 2': 1282100, 'Monster Hunter: World': 582010,
  'Monster Hunter Wilds': 2246340, 'Armored Core VI': 1888160, 'Sekiro': 814380,
  'Dark Souls III': 374320, 'Lies of P': 1627720, 'Bully': 12200,
  'Max Payne 3': 204100, 'L.A. Noire': 110800, 'Sleeping Dogs': 307690,
  'Yakuza 0': 638970, 'Persona 5 Royal': 1687950, 'Horizon Zero Dawn': 1151640,
  'The Last of Us Part I': 1888930, 'Uncharted': 1659420,
  'Ghost of Tsushima': 2215430, 'Days Gone': 1259420,
  'Ratchet & Clank': 1895880, 'Death Stranding': 1190460, 'Stray': 1332010,
  'Outer Wilds': 753640, 'Tunic': 553420, 'Dave the Diver': 1868140,
  'Vampire Survivors': 1794680, 'Balatro': 2379780, 'Slay the Spire': 646570,
  'Portal 2': 620, 'Half-Life: Alyx': 546560, 'It Takes Two': 1426210,
  'A Way Out': 1222700, 'SOMA': 282140, 'Alien: Isolation': 214490,
  'eFootball': 1665460, 'Detroit: Become Human': 1222140, 'Returnal': 1649240,
};
...
function renderGames() {
  ...
  grid.innerHTML = items.map((e) => {
    ...
    <div class="game-card card" data-game-card="${esc(e.title)}">
      <div class="game-top">
        <div class="game-avatar game-cover" title="${esc(e.title)}" style="background:linear-gradient(135deg,hsl(${gameHue(e.title)},55%,38%),hsl(${(gameHue(e.title) + 40) % 360},55%,24%));">${art ? `<img src="${art}" alt="${esc(e.title)}" width="104" height="48" loading="eager" draggable="false" >` : ''}<span>${esc(gameInitials(e.title))}</span></div>
  ...
  grid.querySelectorAll('.game-avatar.game-cover').forEach(box => {
    const img = box.querySelector('img'), label = box.querySelector('span');
    if (!img || !label) return;
    const hideLabel = () => { label.style.display = 'none'; };
    if (img.complete && img.naturalWidth > 0) hideLabel();
